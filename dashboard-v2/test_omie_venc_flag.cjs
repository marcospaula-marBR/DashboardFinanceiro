...
async function run() {
  ...
  // Testar filtrar_apenas_vencimento: "S"
  await test('filtrar_apenas_vencimento: "S"', {
    pagina: 1, registros_por_pagina: 5,
    filtrar_por_data_de: de, filtrar_por_data_ate: ate,
    filtrar_apenas_vencimento: 'S'
  });

  // Testar filtrar_apenas_vencimento: "N"
  await test('filtrar_apenas_vencimento: "N"', {
    pagina: 1, registros_por_pagina: 5,
    filtrar_por_data_de: de, filtrar_por_data_ate: ate,
    filtrar_apenas_vencimento: 'N'
  });
}
